...
int32_t FunctionServlet::handle(radixun::http::HttpRequest::ptr request
...
int32_t ServletDispatch::handle(radixun::http::HttpRequest::ptr request
               , radixun::http::HttpResponse::ptr response
               , radixun::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(radixun::http::HttpRequest::ptr request
                   , radixun::http::HttpResponse::ptr response
                   , radixun::http::HttpSession::ptr session) {
    static const std::string& RSP_BODY = "<html><head><title>404 Not Found"
        "</title></head><body><center><h1>404 Not Found</h1></center>"
        "<hr><center>radixun/1.0.0</center></body></html>";

    response->setStatus(radixun::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "radixun/1.0.0");
